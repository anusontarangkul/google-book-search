...
function Results({ results, handleSave }) {
  return <article className="resultsContainer container container-fluid justify-content-center">
      ...
      <div key={index} class="card">
        <div class="body">
          <div class="row">
            ...
            <div class="col-4">
              <button class="view btn btn-outline-success" onClick={event => handleSave(event, index)}>Save</button>
